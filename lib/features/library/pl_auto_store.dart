...
///
/// Отмеченные плейлисты обходятся по очереди и получают свежий состав из своего
/// источника. На ПК источников у плейлиста может быть несколько (`pl.sources`),
/// у нас — ровно одна ссылка (`sourceUrl`), из которой он и был импортирован,
/// так что кандидат — любой плейлист с ней.
///
